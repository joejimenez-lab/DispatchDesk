...
insert into public.loads (
  id, load_number, broker_id, carrier_company, driver_id, truck_unit_id, trailer_unit_id,
  ...
  ('14000000-0000-4000-8000-000000000001', 'RD-260717-01', '12000000-0000-4000-8000-000000000001', 'RD', '11000000-0000-4000-8000-000000000001', '13000000-0000-4000-8000-000000000001', '13000000-0000-4000-8000-000000000004', 'Ontario, CA', current_date, 'Phoenix, AZ', current_date + 1, false, null, null, 2850, 1625, 285, 510, 'Showcase load with all document categories. Check call every four hours.', 'In Transit', now() - interval '1 day'),
  ('14000000-0000-4000-8000-000000000002', 'RC-260718-01', '12000000-0000-4000-8000-000000000002', 'RC', '11000000-0000-4000-8000-000000000004', '13000000-0000-4000-8000-000000000007', '13000000-0000-4000-8000-000000000010', 'San Diego, CA', current_date + 1, 'Las Vegas, NV', current_date + 2, false, null, null, 2100, 1225, 210, 360, 'Pickup number SOL-88314. Driver must bring two load locks.', 'Dispatched', now() - interval '10 hours'),
  ('14000000-0000-4000-8000-000000000003', 'RD-260716-02', '12000000-0000-4000-8000-000000000003', 'RD', '11000000-0000-4000-8000-000000000002', '13000000-0000-4000-8000-000000000002', '13000000-0000-4000-8000-000000000005', 'Fontana, CA', current_date - 1, 'El Paso, TX', current_date + 1, false, null, null, 3950, 2180, 395, 760, 'Sealed trailer. Receiver appointment is firm.', 'Picked Up', now() - interval '2 days'),
  ...
  ('14000000-0000-4000-8000-000000000011', 'RD-260622-02', '12000000-0000-4000-8000-000000000003', 'RD', '11000000-0000-4000-8000-000000000003', '13000000-0000-4000-8000-000000000003', '13000000-0000-4000-8000-000000000006', 'San Bernardino, CA', current_date - 27, 'Dallas, TX', current_date - 24, false, null, null, 5100, 2810, 510, 1040, 'Client paid; driver settlement is intentionally still pending.', 'Delivered', now() - interval '29 days'),
  ('14000000-0000-4000-8000-000000000012', 'RC-260716-03', '12000000-0000-4000-8000-000000000004', 'RC', '11000000-0000-4000-8000-000000000006', '13000000-0000-4000-8000-000000000009', '13000000-0000-4000-8000-000000000012', 'Stockton, CA', current_date - 1, 'Eugene, OR', current_date + 1, false, null, null, 3400, 1940, 340, 650, 'Expedited retail replenishment. Delivery before noon.', 'In Transit', now() - interval '2 days'),
...
update public.loads
set documents_complete_at = coalesce(delivery_date::timestamptz, created_at)
