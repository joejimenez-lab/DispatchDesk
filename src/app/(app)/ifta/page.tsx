...
import { addIftaFuelPurchase, addIftaTrip, deleteIftaFuelPurchase, deleteIftaTrip, updateIftaFuelPurchase } from "@/lib/actions/ifta";
            ...
            <tbody className="divide-y divide-zinc-100">
              {purchases.map((purchase) => (
                <tr key={purchase.id} className="hover:bg-zinc-50">
                  ...
                  <td className="px-4 py-3 text-right">
                    {(() => {
                      const group = purchase.bookkeeping_expense_groups?.[0];
                      return (
                        <div className="flex flex-wrap justify-end gap-2">
                          ...
                          <ActionForm action={deleteIftaFuelPurchase.bind(null, purchase.id)} successMessage={false}>
                            <ConfirmSubmitButton message="Delete this fuel purchase and its linked Bookkeeping transaction?" variant="secondary">Delete</ConfirmSubmitButton>
                          </ActionForm>
                        </div>
                      );
                    })()}
